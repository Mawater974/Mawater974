      ...
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-[100] bg-white dark:bg-gray-800 overflow-y-auto">
          ...
          <div className="px-4 py-6 flex flex-col pb-20">
            ...
            <Link to={getLink("/services")} onClick={() => setIsMenuOpen(false)} className="block py-2 text-lg font-bold">{t('nav.services')}</Link>
            <Link to={getLink("/rental")} onClick={() => setIsMenuOpen(false)} className="block py-2 text-lg font-bold">{t('nav.rental')}</Link>
