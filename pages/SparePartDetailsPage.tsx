...
import { getSparePartById, getSimilarSpareParts } from '../services/dataService';
    ...
    return (
        <div className="pb-12 relative">
            ...
            {part.status && part.status !== 'approved' && (
                <div className="absolute inset-0 z-40 pointer-events-none flex items-center justify-center overflow-hidden h-[60vh] ">
