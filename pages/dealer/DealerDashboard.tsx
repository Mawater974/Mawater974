                ...
                <div className="container mx-auto px-4 pt-6 max-w-7xl">
                    ...
                    <div className="flex gap-8 overflow-x-auto scrollbar-hide">
                        <button
                            ...
                            className={`pb-4 px-2 flex items-center gap-2 font-bold text-sm transition-all border-b-2 whitespace-nowrap ${activeTab === 'dashboard'
                        ...
                        <button
                            ...
                            className={`pb-4 px-2 flex items-center gap-2 font-bold text-sm transition-all border-b-2 whitespace-nowrap ${activeTab === 'inventory'
                                    ? 'border-primary-600 text-primary-600'
                                    : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`pb-4 px-2 flex items-center gap-2 font-bold text-sm transition-all border-b-2 whitespace-nowrap ${activeTab === 'parts'
                                    ? 'border-primary-600 text-primary-600'
                                    : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`pb-4 px-2 flex items-center gap-2 font-bold text-sm transition-all border-b-2 whitespace-nowrap ${activeTab === 'profile'
                                    ? 'border-primary-600 text-primary-600'
                                    : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'
                                }`}
                        >
                                    ...
                                    <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                                        {cars.length === 0 ? (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className={`px-2.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${car.status === 'approved' ? 'bg-green-100 text-green-700' :
                                    ...
                                    <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                                        {parts.length === 0 ? (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className={`px-2.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${part.status === 'approved' ? 'bg-green-100 text-green-700' :
